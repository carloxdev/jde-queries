  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "NUVPD"."VIEW_IASIENTOS" ("DOC_COMPANIA", "DOC_TIPO", "DOC", "CUENTA_NUMERO", "CUENTA", "CUENTA_DESC", "CUENTA_UN", "CUENTA_CLASE", "CUENTA_CLASE_DESC", "CUENTA_TIPO", "CUENTA_TIPO_DESC", "CUENTA_FLUJO", "CUENTA_FLUJO_DESC", "CUENTA_CLASE_PORF", "CUENTA_CLASE_PORF_DESC", "MONTO", "PORCENTAJE") AS 
  SELECT
          DOC_COMPANIA
          ,DOC_TIPO
          ,DOC
        ...
        from (
                ...
                WHERE ASIENTO.GLLT = 'AA'        --< Solo asientOos en pesos
