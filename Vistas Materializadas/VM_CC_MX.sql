  ...
  CREATE MATERIALIZED VIEW "NUVPD"."VM_CC_MX" ("BENEFICIARIO", "BENEFICIARIO_DESC", "BENEFICIARIO_CLASE5", "BENEFICIARIO_CLASE5_DESC", "UN", "UN_DESC", "UN_PROYECTO", "UN_PROYECTO_DESC", "UN_PROYECTO_ZONA", "UN_PROYECTO_TIPO", "ANIO", "PERIODO", "COMPANIA", "DOC_TIPO", "DOC", "CUENTA", "CUENTA_NUMERO", "CUENTA_DESC", "CUENTA_CLASE_DESC", "CUENTA_TIPO", "CUENTA_FLUJO", "TOTAL", "ENERO", "FEBRERO", "MARZO", "ABRIL", "MAYO", "JUNIO", "JULIO", "AGOSTO", "SEPTIEMBRE", "OCTUBRE", "NOVIEMBRE", "DICIEMBRE")
 ...
 NOCOMPRESS LOGGING
  ...
  AS SELECT PAGOS.BENEFICIARIO,
       ...
       END
          DICIEMBRE
  FROM NUVPD.VIEW_IPAGOS_MX PAGOS
   ...
   COMMENT ON MATERIALIZED VIEW "NUVPD"."VM_CC_MX"  IS 'snapshot table for snapshot NUVPD.VM_CC_MX';
